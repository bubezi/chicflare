"""
Django settings for mySpac3 project.
...
ALLOWED_HOSTS = ['blackiriku.pythonanywhere.com']
...
AUTO_LOGOUT_DELAY = 300  # 5 minutes after inactivity

ROOT_URLCONF = 'mySpac3.urls'
...
WSGI_APPLICATION = 'mySpac3.wsgi.application'
